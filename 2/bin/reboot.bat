...
::最后要把检查连接里涉及的结果传出
ENDLOCAL & set chkdev__edl_port=%chkdev__edl_port%& set chkdev__edl__port=%chkdev__edl__port%& set chkdev__diag901d_port=%chkdev__diag901d_port%& set chkdev__diag901d__port=%chkdev__diag901d__port%
goto :eof
